...
export function Environment(name: string): BaseURL {
    return `https://${name}-vmmyu.encr.app`
}
...
/**
 * Client is an API client for the vmmyu Encore application.
 */
...
export namespace frontend {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.nextjs = this.nextjs.bind(this)
        }

        public async nextjs(method: "GET" | "POST" | "PATCH" | "PUT" | "DELETE" | "HEAD" | "OPTIONS" | "TRACE", rest: string[], body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "vmmyu-Generated-TS-Client (Encore/v1.54.2)";
        }
